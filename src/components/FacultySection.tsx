    ...
    <section id="faculty" className="section-padding bg-muted/50">
      <div className="container-custom mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="section-title">{t('Meet Our Expert Teachers', 'हाम्रा विशेषज्ञ शिक्षकहरूलाई भेट्नुहोस्')}</h2>
          <p className="section-subtitle">
            {t('Our dedicated faculty comprises highly qualified educators committed to nurturing excellence in every student.',
              'हाम्रो समर्पित शिक्षकहरू उच्च योग्यता भएका शिक्षाविद्हरू हुन् जो हरेक विद्यार्थीमा उत्कृष्टता पोषण गर्न प्रतिबद्ध छन्।')}
          </p>
        </div>
            ...
            >
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-foreground/80 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  {member.email && (
                    <a href={`mailto:${member.email}`} className="w-10 h-10 rounded-full bg-card flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground mb-4">
            {t('Our faculty is always ready to help students excel.', 'हाम्रो शिक्षकहरू विद्यार्थीहरूलाई उत्कृष्ट बन्न सधैं तयार छन्।')}
          </p>
          <a href="#contact" className="inline-flex items-center gap-2 text-primary font-semibold hover:underline">
            {t('Get in touch with our teachers', 'हाम्रा शिक्षकहरूसँग सम्पर्क गर्नुहोस्')}
